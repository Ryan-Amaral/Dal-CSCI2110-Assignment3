...
<p>Of note is the files in the output folder. The dot files were generated by this program to be used by the program Graphviz to generate a graph of the quad tree. The PDFs of a few graphs are also in that folder.</p>

Sample Output:
<pre>
Adding 2000 points to QuadTree took 3 nanoseconds.
Adding 2000 points to Simple took 0 nanoseconds.
Calling count 10000 times on Quadree takes 94 nanoseconds.
Calling count 10000 times on Simple takes 180 nanoseconds.
